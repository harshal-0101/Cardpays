...
<div class="crm-sidebar">
    ...
    <nav class="flex-1 overflow-y-auto">
        ...
        @php
            ...
            $dropdownActiveClass = 'dropdown-link-active';
            $dropdownInactiveClass = 'dropdown-link-inactive';
        @endphp
        ...
        <a href="{{ route('manager.manager') }}"     
         ...
         <a href="{{ route('payment.payment') }}"     
           class="nav-link mt-4 
           {{ request()->routeIs('payment.payment') ? $activeClass : $inactiveClass }}"> 
        ...
        <a href="{{ route('leadOffer.index') }}"     
           class="nav-link mt-4 
           {{ request()->routeIs('leadOffer.index') ? $activeClass : $inactiveClass }}"> 
        ...
        <a href="{{ route('expense.index') }}"     
           class="nav-link mt-4 
           {{ request()->routeIs('expense.index') ? $activeClass : $inactiveClass }}"> 
           
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M441-120v-86q-53-12-91.5-46T293-348l74-30q15 48 44.5 73t77.5 25q41 0 69.5-18.5T587-356q0-35-22-55.5T463-458q-86-27-118-64.5T313-614q0-65 42-101t86-41v-84h80v84q50 8 82.5 36.5T651-650l-74 32q-12-32-34-48t-60-16q-44 0-67 19.5T393-614q0 33 30 52t104 40q69 20 104.5 63.5T667-358q0 71-42 108t-104 46v84h-80Z"/></svg>
            Expense Management
        </a>

     <div class="sidebar-dropdown  {{ request()->is('setting*') ? 'active' : '' }} ">

         <button class="dropdown-btn {{ request()->is('setting*') ? 'active' : '' }} " >
      ...
      <div class="dropdown-content ">
            <a href="{{ route('setting.setting') }}"     
             class="nav-link mt-4 
             {{ request()->routeIs('setting.setting') ? $activeClass : $inactiveClass }}"> 
             
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="m370-80-16-128q-13-5-24.5-12T307-235l-119 50L78-375l103-78q-1-7-1-13.5v-27q0-6.5 1-13.5L78-585l110-190 119 50q11-8 23-15t24-12l16-128h220l16 128q13 5 24.5 12t22.5 15l119-50 110 190-103 78q1 7 1 13.5v27q0 6.5-2 13.5l103 78-110 190-118-50q-11 8-23 15t-24 12L590-80H370Zm70-80h79l14-106q31-8 57.5-23.5T639-327l99 41 39-68-86-65q5-14 7-29.5t2-31.5q0-16-2-31.5t-7-29.5l86-65-39-68-99 42q-22-23-48.5-38.5T533-694l-13-106h-79l-14 106q-31 8-57.5 23.5T321-633l-99-41-39 68 86 64q-5 15-7 30t-2 32q0 16 2 31t7 30l-86 65 39 68 99-42q22 23 48.5 38.5T427-266l13 106Zm42-180q58 0 99-41t41-99q0-58-41-99t-99-41q-59 0-99.5 41T342-480q0 58 40.5 99t99.5 41Zm-2-140Z"/></svg>
              Settings
          </a>

          <a href="{{ route('setting.payment_mode') }}"     
           class="nav-link mt-4 
           {{ request()->routeIs('setting.payment_mode') ? $activeClass : $inactiveClass }}"> 
          ...
          <a href="{{ route('setting.public_form') }}"     
           class="nav-link mt-4 
           {{ request()->routeIs('setting.public_form') ? $activeClass : $inactiveClass }}"> 
          ...
          <a href="{{ route('setting.taxes') }}"     
           class="nav-link mt-4 
           {{ request()->routeIs('setting.taxes') ? $activeClass : $inactiveClass }}"> 
          ...
          <a href="{{ route('setting.adminlist') }}"     
           class="nav-link mt-4 
           {{ request()->routeIs('setting.adminlist') ? $activeClass : $inactiveClass }}"> 
